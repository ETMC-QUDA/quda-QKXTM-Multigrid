...
#include <dslash_init.cuh>
				      ...
				      const QudaTwistGamma5Type twistType) const
  {
    ...
    //printfQuda("\n Fnct DiracTwistedMass::twistedApply BEFORE Twist in = %d   Twist out = %d\n",
    //in.TwistFlavor(), out.TwistFlavor() );
    ...
    //QKXTM::DMH 
    //printfQuda("\n Fnct DiracTwistedMass::twistedApply AFTER Twist in = %d   Twist out = %d\n",
    //in.TwistFlavor(), out.TwistFlavor() );
  ...
  void DiracTwistedMass::M(ColorSpinorField &out, const ColorSpinorField &in) const
  {
    ...
    //QKXTM: DMH
    //printfQuda("\n Fnct DiracTwistedMass::M Twist in = %d   Twist out = %d\n",
    //in.TwistFlavor(), out.TwistFlavor() );
  ...
  void DiracTwistedMass::MdagM(ColorSpinorField &out, const ColorSpinorField &in) const
  {
    ...
    //QKXTM: DMH
    //printfQuda("\n Fnct DiracTwistedMass::MdagM Twist in = %d   Twist out = %d\n",
    //in.TwistFlavor(), out.TwistFlavor() );
  ...
  (ColorSpinorField &out, const ColorSpinorField &in, const QudaParity parity) const
  {
    ...
    //QKXTM: DMH
    //printfQuda("\n Fnct DiracTwistedMassPC::Dslash Twist in = %d   Twist out = %d\n",
    //in.TwistFlavor(), out.TwistFlavor() );
  ...
  (ColorSpinorField &out, const ColorSpinorField &in, const QudaParity parity, const ColorSpinorField &x, const double &k) const
  {
    ...
    //QKXTM: DMH
    //printfQuda("\n Fnct DiracTwistedMassPC::DslashXpay Twist in = %d   Twist out = %d\n",
    //in.TwistFlavor(), out.TwistFlavor() );
  ...
  void DiracTwistedMassPC::MdagM(ColorSpinorField &out, const ColorSpinorField &in) const
  {
    ...
    //QKXTM: DMH
    //printfQuda("\n Fnct DiracTwistedMassPC::MdagM Twist in = %d   Twist out = %d\n",
    //in.TwistFlavor(), out.TwistFlavor() );
